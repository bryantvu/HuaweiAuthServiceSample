...
public class HWGameActivity extends BaseAuthActivity {
    ...
    protected void unlink() {
        auth.getCurrentUser().unlink(AGConnectAuthCredential.HWGame_Provider);
    }
        ...
        if (SIGN_CODE == requestCode) {
            ...
            task.addOnSuccessListener(new OnSuccessListener<AuthHuaweiId>() {
                ...
                public void onSuccess(AuthHuaweiId authHuaweiId) {
                    ...
                    currentPlayerInfo(requestCode, authHuaweiId);
                }
