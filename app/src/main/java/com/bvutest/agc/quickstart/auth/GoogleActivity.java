...
public class GoogleActivity extends BaseAuthActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GoogleSignInOptions options =
                new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken(getString(R.string.google_client_id)).build();
    ...
    protected void unlink() {
        auth.getCurrentUser().unlink(AGConnectAuthCredential.Google_Provider);
    }
